function loadContent(root, suffix, currentPage) {
 ...
 //   let objects = JSON.parse(Get(root + "/rest/players" + suffix).responseText);
    ...
    let abc = Get(root + "/rest/players" + suffix).responseText;
//    alert('loadContext abc: ' + abc);
    let objects = JSON.parse(abc);
...
function Get(requestUrl) {
    ...
    alert('GET url=' + requestUrl + " resp.status = " + Httpreq.status + ' responseText = ' + Httpreq.responseText);
    return Httpreq;
}

function post(requestUrl, body) {
    console.log('POST url=' + requestUrl + ' requestBody = ' + body);
    ...
    alert('POST url=' + requestUrl + " resp.status = " + Httpreq.status + ' responseText = ' + Httpreq.responseText);
